									...
									<fieldset>
										<div class="row">
											...
											<label>First Name <span class="text-danger">*</span></label>
												<input type="text" class="form-control" placeholder="Mojica">
											</div>
											<div class="col-sm-4">
										...
										<div class="row">
											...
											<label>Contact Number <span class="text-danger">*</span></label>											
												<div class="input-group">
													<input type="text" class="form-control" data-mask="(999) 999-9999" data-mask-placeholder="0">
										...
										<div class="form-group">
											<label>Address</label>
											<textarea class="form-control" placeholder="123 Unknown RoadEvacom Road Paranaque City" rows="3"></textarea>
										</div>
									</fieldset>
									<div>
